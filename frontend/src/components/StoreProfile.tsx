...
const StoreProfile = ({ store, isSeller, onUpdate }: props) => {
  ...
  return (
    <div className="card-elevated mx-auto max-w-xl overflow-hidden p-0">
      {store.image && (
        <img
          src={store.image}
          alt=""
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="mt-1 flex items-center gap-2 text-sm text-gray-500">
              <BiMapPin className="h-4 w-4 text-gray-700" />
          ...
          <div className="flex gap-3">
            ...
            {isSeller && (
              <button
                ...
                className="rounded-lg border border-gray-200 px-4 py-1.5 text-sm font-medium text-gray-900 transition-colors hover:border-black"
              >
                Logout
              </button>
            )}
